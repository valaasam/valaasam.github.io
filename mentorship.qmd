...
<div style="display: flex; justify-content: space-around;">
  <figure style="width: 30%; margin: 0 5px; text-align: center;">
    ...
    <figcaption>**Rafael E. Baez-Segui**<br>(M.Sc.)</figcaption>
  </figure>
  
  <figure style="width: 30%; margin: 0 5px; text-align: center;">
    <img src="Rafael.jpeg" alt="Image 2" style="width: 100%;">
    <figcaption>**Gaia Rueda Moreno**<br>(Senior, undergrad)</figcaption>
  </figure>
  
  <figure style="width: 30%; margin: 0 5px; text-align: center;">
    <img src="Rafael.jpeg" alt="Image 3" style="width: 100%;">
...
\
<div div style="background-color: #f1eeda; padding: 15px; margin: 20px 0; text-align: center; font-size: 20px;">
  <p style="margin: 0;">
