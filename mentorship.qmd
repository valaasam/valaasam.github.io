...
PhD student Fallon Meng and I are conducting a study to ask whether the metabolic rate might be changing as a mechanism of coping with urban heat, and how might this be facilitating their invasion.
:::
:::
...
::: {div="" style="background-color: #f1eeda; padding: 15px; margin: 20px 0; text-align: center; font-size: 20px;"}
<p style="margin: 0;">
...
\
Bototá (Colombia) **·** Fusagasugá (Colombia) **·** Gamboa (Panama) **·** Panama City (Panama) **·** Seattle (Washington, USA)
