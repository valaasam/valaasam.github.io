...
Alyssa Sargent and I working in one of our favorite backyards, Fall 2023.
...
Puerto Rican Mango (male), Dorado, PR. Red marking on the crown is a small dot of non-toxic fabric paint that we place to identify and avoid recapturing the same individual.
...
What are the molecular mechanisms underlying behavioral and physiological responses? To understand this, my research involves using **next-generation sequencing** techniques to measure differences in gene expression resulting from exposure to various environmental conditions. For example, I have shown that behavioral and endocrine disruption resulting from light pollution exposure occurs independently from the central circadian clock ([*Environmental Pollution, 2021*](https://www.sciencedirect.com/science/article/abs/pii/S0269749121006187?via%3Dihub)). RNA sequencing of red blood cells, which is minimally invasive and allows for repeated measures of gene expression within-individuals, revealed processes underlying habituation to light pollution over time ([*iScience, 2024*](https://www.cell.com/action/showPdf?pii=S2589-0042%2824%2900085-3)). I have also developed methods in **immunocytochemistry** enabling us to to map neuron activity in the brain during exposure to night-light.
:::
...
::: {style="text-align: right;"}
[*Frontiers in Nueroscience, 2023*](https://pmc.ncbi.nlm.nih.gov/articles/PMC10352805/pdf/fnins-17-1194996.pdf)
:::
:::
:::
...
::: {style="display: flex; justify-content: space-around;"}
<img src="comeng1.JPG" alt="Im1" style="width: 50%; margin: 0 10px;"/> <img src="comeng2.jpg" alt="Im2" style="width: 44%; margin: 0 10px;"/>
:::

::: {style="display: flex; justify-content: space-around;"}
<img src="comeng3.jpg" alt="Im4" style="width: 33.5%; margin: 0 10px;"/> <img src="comeng4.png" alt="Im5" style="width: 25.2%; margin: 0 10px;"/> <img src="comeng6.jpg" alt="Im6" style="width: 33.3%; margin: 0 10px;"/>
:::

::: {style="display: flex; justify-content: space-around;"}
<img src="comeng5.jpg" alt="Im2" style="width: 47%; margin: 0 10px;"/> <img src="comeng8.jpeg" alt="Im3" style="width: 47%; margin: 0 10px;"/>
:::

::: {style="display: flex; justify-content: space-around;"}
<img src="comeng7.jpg" alt="Im7" style="width: 31.6%; margin: 0 10px;"/> <img src="comeng9.jpeg" alt="Im9" style="width: 31.6%; margin: 0 10px;"/> <img src="comeng10.jpeg" alt="Im10" style="width: 28.8%; margin: 0 10px;"/>
:::
:::
